...
//  ATBasicSounds
//
//  Created by Audrey M Tam on 1/10/2016.
...
- (void)configureAudioPlayer {
    // Create audio player with background music   .mp3
...
- (void)configureSystemSound {
    ...
    NSString *pewPewPath = [[NSBundle mainBundle] pathForResource:@"Iphone Sms Original (1)" ofType:@"mp3"];
